...
void Model::Draw(D3D12_GPU_DESCRIPTOR_HANDLE handle) {
	//モデルの描画
	common_->GetCommandList()->IASetVertexBuffers(0, 1, &vertexBufferView_);//VBVを設定
	...
	common_->GetCommandList()->SetGraphicsRootDescriptorTable(2, handle);
	//描画!3頂点で1つのインスタンス
